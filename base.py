# Imported from https://github.com/loganmeetsworld/aoc_utils
#
...
COOKIE = "53616c7465645f5f8dd6a9e88bf573bc2646543316bade331b34a0385d4507db0a7fd055d1f894e3b6789582ed2475963b4f835249d033729dd127e2a9709143"
...
def save(year, day, content_type):
    ...
    with open(f"{CURRENT_DIR}/{content_type}_{year}_{day}.txt", "w") as text_file:
...
def fetch_and_save(year, day):
    if os.path.exists(f"{CURRENT_DIR}/input_{year}_{day}.txt"):
        print("\n🛷  Found input locally, using saved input 🛷 \n")
        with open(f"{CURRENT_DIR}/input_{year}_{day}.txt") as file:
            return file.read()
    else:
